...
We are excited to announce our first maintenance release after v0.6 with dozens of bug fixes and improvements. Please go to our [Download Page]({{ translated_pages | where: "ref", "download" | map: "url" | first | relative_url }}) and download the new version.
