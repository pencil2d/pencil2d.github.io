...
Depending on the name of the missing file, this error can occur for different reasons. Please check [the Troubleshooting Guide](/download/#troubleshooting) for some of the most common cases. If your particular case isn't solved there, please [let us know]({{ translated_pages | where: "ref", "community" | map: "url" | first | relative_url }}).
...
We urgently need users' feedback from these systems since the devs don't have these old Operating Systems anymore. If you own a older machine that can run macOS 10.7-10.11 or Windows XP, and you'd like to help test, [please contact the devs]({{ translated_pages | where: "ref", "community" | map: "url" | first | relative_url }})!
...
Pencil2D won't get hot just by looking at it, in fact there's more chances that you'll hate it the more you look at it. We need YOU for miracles to happen! [Consider donating your time]({{ translated_pages | where: "ref", "contribute" | map: "url" | first | relative_url }}) to report bugs, create art or just hang out with us at the forum while we wait for the next release.

For more information on how to contribute to Pencil2D please visit the **[Contribute]({{ translated_pages | where: "ref", "contribute" | map: "url" | first | relative_url }})** Page.
