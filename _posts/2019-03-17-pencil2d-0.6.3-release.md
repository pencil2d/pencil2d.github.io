...
- [#1111](https://github.com/pencil2d/pencil/pull/1111) Fixed possibly frame lost during file save.
- [#1107](https://github.com/pencil2d/pencil/issues/1107) Fixed miscellaneous g++ compiler warnings.
...
- [#1096](https://github.com/pencil2d/pencil/issues/1096) Fixed crash and related issues on layer delete.
- [#1095](https://github.com/pencil2d/pencil/issues/1095) Fixed move tool crash on camera layer.
- [#1090](https://github.com/pencil2d/pencil/issues/1090), [#1123](https://github.com/pencil2d/pencil/pull/1123) Fixed image export issues (by [przet](https://github.com/przet)).
...
While there seems to be a growing list of Know issues, make no mistake, we are working hard on reviewing and fixing them as thoroughly as possible.
...
- [#940](https://github.com/pencil2d/pencil/pull/940) Pending improvements: project is corrupted because comma is used as decimal separator in some countries instead of period.
...
- [#1174](https://github.com/pencil2d/pencil/issues/1174) Inconsistent palette import behavior: the new palette may append or overwrite the existing palette depending on the file format.
...
- [#1179](https://github.com/pencil2d/pencil/issues/1179) An audio delay of 1-2 frames between in-editor playback & exported files. However on some systems the opposite happens where the audio delay on playback might be longer by 12-16 or more frames, but on export it works ok.
...
- In general the Vector Engine is not ready for production use, please avoid using it for serious work.
