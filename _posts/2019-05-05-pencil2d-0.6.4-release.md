...
Yes, your eyes are not deceiving you, we have another release for you! A mere 1.5 months after v0.6.3, we are releasing v0.6.4. This is a is part of a new release strategy we are testing out right now, more details can be found on that below. The gist is that this release only has bugfixes so that we can make your experience as stable and trouble-free as possible.
