...
| --------- | ------ | ----- |
| <video autoplay controls height=200 src="{{ "/images/pencil2d-0.7.0-camera-translate.mp4" | relative_url }}"/> | <video controls autoplay height=200 src="{{ "/images/pencil2d-0.7.0-camera-rotate.mp4" }}"/> | <video autoplay controls height=200 src="{{ "/images/pencil2d-0.7.0-camera-scale.mp4" }}"/> |
